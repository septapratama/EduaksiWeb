...
<body>
                                    ...
                                    <div class="tab-content pt-2">
                                        <div class="tab-pane fade show active profile-overview" id="profile-overview">
                                            <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
                                                <img src="{{ asset($tPath.'assets/images/profile/user-1.jpg') }}" alt="Profile" class="">
                                                <h2>
                                                    <center>
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-md-8 col-lg-9">
                                                    <div id="divImg" ondrop="dropHandler(event)" ondragover="dragHandler(event,'over')" ondragleave="dragHandler(event,'leave')">
                                                        ...
                                                        <img src="{{ asset($tPath.'assets/images/profile/user-1.jpg') }}" alt="Profile" id="inpImg" class="">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-md-8 col-lg-9">
                                                    <input name="nama" type="text" class="form-control" id="Nama Lengkap" value="{{ $userAuth['nama_lengkap'] }}">
                                                </div>
                                            </div>
                                            <div class="row mb-3">
                                            <label for="Nomor Telepon" class="col-md-4 col-lg-3 col-form-label">Nomor Telepon</label>
                                                <div class="col-md-8 col-lg-9">
                                                    <input name="phone" type="text" class="form-control" id="phone" value="{{ $userAuth['no_telpon'] }}">
                                                </div>
                                            </div>
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-md-8 col-lg-9">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" name="jenisK" value="laki-laki" {{ ($userAuth['jenis_kelamin'] == 'laki-laki') ? 'checked' : '' }}> Laki-Laki
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" name="jenisK" value="perempuan" {{ ($userAuth['jenis_kelamin'] == 'perempuan') ? 'checked' : '' }}> Perempuan
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-md-8 col-lg-9">
                                                    <input name="email" type="email" class="form-control" id="Email" value="{{ $userAuth['email'] }}">
                                                </div>
                                            </div>
    ...
    <script>
        ...
        function uploadEdit(event){
            ...
            if((fileImg === null || fileImg === '') && inpNama === users.nama_lengkap && inpTLP === users.no_telpon && inpJenis === users.jenis_kelamin && inpEmail === users.email){
