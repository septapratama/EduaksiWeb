            ...
            <div class="container-fluid">
                ...
                <div class="d-flex align-items-stretch">
                    <div class="card w-100">
                        ...
                        <form id="tambahForm">
                                <div class="mb-3">
                                    <label for="" class="form-label">Judul Emosi Mental</label>
                                    <input type="text" class="form-control" id="inpJudul" aria-describedby="emailHelp">
                                </div>
                                <div class="mb-3">
                                    <div>
                                        <label for="" class="form-label">Rentang Usia</label>
                                        <select class="form-select" aria-label="Default select example" id="inpRentangUsia">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="deskripsi" id="inpDeskripsi" placeholder="Masukkan Isi Emosi Mental" class="form-control" style="height:120px"></textarea>
                                </div>
                                <div class="mb-3">
