...
<head>
    ...
    <title>Data Acara | EduAksi</title>
                ...
                <div class="pagetitle">
                    ...
                    <nav>
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">Kelola Acara</li>
                        </ol>
                    </nav>
                </div>
                <div class="d-flex align-items-stretch">
                    <div class="card w-100">
                        <div class="card-body p-4"
                            ...
                            <a href="/acara/tambah" class="btn btn-success" id="btnTambah">
                                ...
                                <table class="table mb-0 align-middle">
                                    <thead class="text-dark fs-4">
                                        <tr>
                                            ...
                                            <th class="border-bottom-0">
                                                <h6 class="fw-semibold mb-0">Naam Acara</h6>
                                            </th>
                                            <th class="border-bottom-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="border-bottom-0">
                                                <span class="fw-normal">{{ $data['nama_event'] }}
                                                </span>
                                            </td>
                                            <td class="border-bottom-0">
                                                <a href="/acara/edit/{{ $data['uuid'] }}" class="btn btn-warning btn-edit m-1">
